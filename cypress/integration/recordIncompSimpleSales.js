...
it('Validate Agent can record Simple incomplete sale', function() {
 ...
 cy.viewport(320, 568)
  ...
  //Click no
  salesRecordPage.getNo().click()

  //Input Payment amount
  salesRecordPage.getPaymentAmount().type(this.data.paymentAmount)

  //Enable Customer info
  salesRecordPage.getEnableCustIfo().click()

  //Input Customer Phone No
  salesRecordPage.getCustomerPhoneNo().type(this.data.customerPhoneNo)

  //Input Customer Name
  salesRecordPage.getCustomerName().type(this.data.customerName)
